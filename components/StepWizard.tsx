      ...
      try {
        ...
        if (result.success && result.data) {
          ...
          if (d.farmerName) {
            ...
            setUploadStatus('✓ Soil values successfully extracted from report!')
          }
          setTimeout(() => {
            setCurrentStep(2)
          }, 800)
          ...
          <div className="bg-emerald-50/70 p-5 rounded-2xl border border-emerald-200/80 shadow-xs">
            <div className="flex items-center justify-between mb-3 flex-wrap gap-2">
              <h4 className="text-xs font-bold text-emerald-950 uppercase tracking-wide flex items-center gap-1.5">
                ...
                Farmer & Report Details (Extracted from Report)
              </h4>
              <span className="text-[11px] text-emerald-700 font-semibold bg-emerald-100/70 px-2 py-0.5 rounded-full">
                Verify or edit farmer name
              </span>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-3 text-xs">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 border border-emerald-300 rounded-xl font-bold text-slate-900 bg-white shadow-xs focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-600"
                />
              </div>
              ...
              <div>
                ...
                <input
                  type="text"
                  placeholder="e.g. SHC-2024-9182"
                  value={farmerDetails.sampleNumber}
                  onChange={(e) =>
                    setFarmerDetails({ ...farmerDetails, sampleNumber: e.target.value })
                  }
                  className="w-full px-3 py-2 border border-slate-300 rounded-xl font-semibold text-slate-800 bg-white shadow-xs"
                />
              </div>
              ...
              <div>
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    onChange={(e) =>
                      setFarmerDetails({ ...farmerDetails, district: e.target.value })
                    }
                    className="w-1/2 px-2.5 py-2 border border-slate-300 rounded-xl font-semibold text-slate-800 bg-white shadow-xs"
                  />
                  <input
                    type="text"
                    placeholder="State"
